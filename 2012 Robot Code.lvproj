...
<Project Type="Project" LVVersion="11008008">
	<Property Name="varPersistentID:{00D480D8-F0DA-4C2C-BB0C-E4561745FD36}" Type="Ref">/RT CompactRIO Target/globals.lvlib/config vars/shifterOneSolenoid?</Property>
	<Property Name="varPersistentID:{0CB48585-7102-4C28-899C-8DDD7E295B84}" Type="Ref">/RT CompactRIO Target/globals.lvlib/config vars/bridgeGrinderIsVictor</Property>
	<Property Name="varPersistentID:{1B01D1D7-F9CA-4AF4-8C19-969E59951A46}" Type="Ref">/RT CompactRIO Target/globals.lvlib/intake vars/ballIntake</Property>
	<Property Name="varPersistentID:{1F0FF278-5DC0-4FF3-AC5D-C48EDBD1E301}" Type="Ref">/RT CompactRIO Target/globals.lvlib/shooter vars/longRange</Property>
	<Property Name="varPersistentID:{1FCB1751-69DF-437F-BE8F-0ED79EC36757}" Type="Ref">/RT CompactRIO Target/globals.lvlib/drive vars/driveShifterLow</Property>
	<Property Name="varPersistentID:{20266E97-C4B6-4245-8985-E687816F038A}" Type="Ref">/RT CompactRIO Target/globals.lvlib/drive vars/lockdown?</Property>
	<Property Name="varPersistentID:{22509DDE-7229-4E7C-8F3F-7E8EA42BB616}" Type="Ref">/RT CompactRIO Target/globals.lvlib/drive vars/rightSidePower</Property>
	<Property Name="varPersistentID:{273E95A1-47E5-41A1-A53D-6026D9E9824A}" Type="Ref">/RT CompactRIO Target/globals.lvlib/config vars/lockdownModePID</Property>
	<Property Name="varPersistentID:{2C094541-CD62-4D68-804A-2E5003F0E1F3}" Type="Ref">/RT CompactRIO Target/globals.lvlib/drive vars/autoTarget</Property>
	<Property Name="varPersistentID:{3D61D8D5-4571-4FBE-A687-6A6EE1019A5B}" Type="Ref">/RT CompactRIO Target/globals.lvlib/config vars/RPMTargetPID</Property>
	<Property Name="varPersistentID:{4A510283-A7C8-467E-B42A-F748419C3EE8}" Type="Ref">/RT CompactRIO Target/globals.lvlib/intake vars/ballEject</Property>
	<Property Name="varPersistentID:{6A8A9C78-F28C-4690-880F-739BCA22738F}" Type="Ref">/RT CompactRIO Target/globals.lvlib/shooter vars/eyeOverride</Property>
	<Property Name="varPersistentID:{817EB434-E8F8-44DF-A599-827F2CE55164}" Type="Ref">/RT CompactRIO Target/globals.lvlib/drive vars/Bridge Grinder Power</Property>
	<Property Name="varPersistentID:{85D0729E-5CE5-4AC8-8302-CFCBE5D55A08}" Type="Ref">/RT CompactRIO Target/globals.lvlib/drive vars/leftSidePower</Property>
	<Property Name="varPersistentID:{8E51993B-C3C5-4FD0-8B1D-C13FDB6D92F8}" Type="Ref">/RT CompactRIO Target/globals.lvlib/config vars/driveShifterSlot3?</Property>
	<Property Name="varPersistentID:{A148C18F-5A01-4499-882C-A572EF13C853}" Type="Ref">/RT CompactRIO Target/globals.lvlib/other vars/robotMode</Property>
	<Property Name="varPersistentID:{AC77B1BC-453F-4472-A997-F318741DD055}" Type="Ref">/RT CompactRIO Target/globals.lvlib/shooter vars/shoot</Property>
	<Property Name="varPersistentID:{B04FD3C5-F9A8-49C3-B15D-6E4B5123C686}" Type="Ref">/RT CompactRIO Target/globals.lvlib/intake vars/rollerDeployOutput</Property>
	<Property Name="varPersistentID:{B1B4EC1A-18AC-41E9-952D-ECA834DFF947}" Type="Ref">/RT CompactRIO Target/globals.lvlib/other vars/autonDelay</Property>
	<Property Name="varPersistentID:{B3466EA8-33BD-4812-89A9-008A1542F407}" Type="Ref">/RT CompactRIO Target/globals.lvlib/drive vars/EncoderReseting</Property>
	<Property Name="varPersistentID:{BD1A1563-0AD7-4D75-8284-BB55B616EE12}" Type="Ref">/RT CompactRIO Target/globals.lvlib/other vars/autonNumber</Property>
	<Property Name="varPersistentID:{CAD78868-BB6C-4AF4-99AF-B315391AE39C}" Type="Ref">/RT CompactRIO Target/globals.lvlib/shooter vars/RPMTarget</Property>
	<Property Name="varPersistentID:{E988B269-74E1-4D82-BD88-C57D1E01BE32}" Type="Ref">/RT CompactRIO Target/globals.lvlib/intake vars/intakeDown</Property>
	<Property Name="varPersistentID:{FD220B3B-53B5-4852-89B4-C8E5527317EF}" Type="Ref">/RT CompactRIO Target/globals.lvlib/shooter vars/shortRange</Property>
...
KeepAliveTimeout 60
		...
		<Item Name="TypeDefs" Type="Folder">
			...
			<Item Name="PIDCluster.ctl" Type="VI" URL="../PIDCluster.ctl"/>
		</Item>
		<Item Name="Team Code" Type="Folder">
			...
			<Item Name="ramp joystick.vi" Type="VI" URL="../ramp joystick.vi"/>
		...
		<Item Name="Vision Support Code" Type="Folder">
			...
			<Item Name="Bounding Box.vi" Type="VI" URL="../Vision and friends/Bounding Box.vi"/>
			<Item Name="Compute Distance.vi" Type="VI" URL="../Vision and friends/Compute Distance.vi"/>
			<Item Name="Compute HSL Color Ranges.vi" Type="VI" URL="../Vision and friends/Compute HSL Color Ranges.vi"/>
			<Item Name="Draw Filled Rect.vi" Type="VI" URL="../Vision and friends/Draw Filled Rect.vi"/>
			<Item Name="Normalized Range Compare.vi" Type="VI" URL="../Vision and friends/Normalized Range Compare.vi"/>
			<Item Name="Rectangularity Score.vi" Type="VI" URL="../Vision and friends/Rectangularity Score.vi"/>
			<Item Name="RT Overlay Helper.vi" Type="VI" URL="../Vision and friends/RT Overlay Helper.vi"/>
			<Item Name="Save images.vi" Type="VI" URL="../Vision and friends/Save images.vi"/>
			<Item Name="Score Particles.vi" Type="VI" URL="../Vision and friends/Score Particles.vi"/>
			<Item Name="SelectorTallestTarget.vi" Type="VI" URL="../Vision and friends/SelectorTallestTarget.vi"/>
			<Item Name="Sorted Particle Report.vi" Type="VI" URL="../Vision and friends/Sorted Particle Report.vi"/>
		</Item>
		<Item Name="Support Code" Type="Folder">
			<Item Name="Get Robot Competition Mode.vi" Type="VI" URL="../Get Robot Competition Mode.vi"/>
			<Item Name="Elapsed Times.vi" Type="VI" URL="../Elapsed Times.vi"/>
		</Item>
		<Item Name="auton and friends" Type="Folder">
			<Item Name="destroy function.vi" Type="VI" URL="../auton and friends/destroy function.vi"/>
			<Item Name="get io data.vi" Type="VI" URL="../auton and friends/get io data.vi"/>
			<Item Name="get set labels.vi" Type="VI" URL="../auton and friends/get set labels.vi"/>
			<Item Name="maintain current instructions.vi" Type="VI" URL="../auton and friends/maintain current instructions.vi"/>
			<Item Name="relative to absolute.vi" Type="VI" URL="../auton and friends/relative to absolute.vi"/>
			<Item Name="remove dead functions.vi" Type="VI" URL="../auton and friends/remove dead functions.vi"/>
			<Item Name="select data.vi" Type="VI" URL="../auton and friends/select data.vi"/>
			<Item Name="start function.vi" Type="VI" URL="../auton and friends/start function.vi"/>
			<Item Name="unpack autonomous file.vi" Type="VI" URL="../auton and friends/unpack autonomous file.vi"/>
			<Item Name="autonomous main.vi" Type="VI" URL="../auton and friends/autonomous main.vi"/>
		</Item>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="FRC Robot Boot-up Deployment" Type="{69A947D5-514E-4E75-818E-69657C0547D8}">
				...
				<Property Name="RTExe_localDestPath" Type="Path">/C/Users/Colin/RoBroCode/OfficialCodeGitHub/2012-Robot-Code/Builds</Property>
				<Property Name="RTExe_localDestPathType" Type="Str">&lt;none&gt;</Property>
				<Property Name="Source[0].itemID" Type="Str">{9F0E57FB-EBDE-4878-AB1A-BDADA32800AE}</Property>
